...
| **OQ-N3** | API names exactos de los módulos CRM: Contacts, Deals (Oportunidad), Accounts (Cuenta). | E-02 (adapter CRM real) | 🔴 abierta |
| **OQ-N4** | ¿`Agendamiento Ready` es un valor de picklist (Stage) existente? ¿Cuál es su API name? | E-02 | 🔴 abierta |
